            ...
            MaterialType::Phong {
                ...
                lights
                    ...
                    .map(|light| {
                        if light.is_ambient() {
                            surface_color
                                * light.get_intensity_at(intersection_point)
                                * light.get_color()
                        } else {
                            let light_direction = light.get_direction(intersection_point).unwrap();
                            let light_color =
                                light.get_intensity_at(intersection_point) * light.get_color();
